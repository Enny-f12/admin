// services/fm.service.ts
// Full-menu variant of menu.service.ts — branchId removed completely.
// getCategories and getItems always return the vendor's full catalog.
